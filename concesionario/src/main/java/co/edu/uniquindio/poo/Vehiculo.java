...
public Vehiculo(String codigo, String marca, String modelo, boolean nuevo, int cambios, double velMax, double cilindraje, Negocio negocio, Combustion combustion, Transmision transmision, Estado estado) {
    this.codigo = codigo;
    this.marca = marca;
    this.modelo = modelo;
    this.nuevo = nuevo;
 ...
 */
public void setVelMaz(double velMax) {
    this.velMaz = velMax;
}
